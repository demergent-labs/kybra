export const idlFactory = ({ IDL }) => {
  const Reaction = IDL.Variant({ 'Great' : IDL.Null, 'Fire' : IDL.Null });
  ...
  return IDL.Service({
    ...
    'read_stable_blobs' : IDL.Func([], [IDL.Vec(IDL.Vec(IDL.Nat8))], ['query']),
    'read_stable_boolean' : IDL.Func([], [IDL.Bool], ['query']),
    'read_stable_float32' : IDL.Func([], [IDL.Float32], ['query']),
    'read_stable_float64' : IDL.Func([], [IDL.Float64], ['query']),
    'read_stable_func' : IDL.Func(
        [],
    ...
    'read_stable_null' : IDL.Func([], [IDL.Null], ['query']),
    'read_stable_opt' : IDL.Func([], [IDL.Opt(IDL.Int)], ['query']),
    'read_stable_principal' : IDL.Func([], [IDL.Principal], ['query']),
    'read_stable_reaction' : IDL.Func([], [Reaction], ['query']),
    ...
    'write_stable_null' : IDL.Func([IDL.Null], [], []),
    'write_stable_opt' : IDL.Func([IDL.Opt(IDL.Int)], [], []),
    'write_stable_principal' : IDL.Func([IDL.Principal], [], []),
    'write_stable_reaction' : IDL.Func([Reaction], [], []),
