...
import { idlFactory } from "./call_raw.did.js";
export { idlFactory } from "./call_raw.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CALL_RAW_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./call_raw.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
...
/**
 * A ready-to-use agent for the call_raw canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./call_raw.did.js")._SERVICE>}
*/
// export const call_raw = createActor(canisterId);
