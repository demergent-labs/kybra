...
import { idlFactory } from './init.did.js';
export { idlFactory } from './init.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.INIT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./init.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
