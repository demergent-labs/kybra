...
import { idlFactory } from './key_value_store.did.js';
export { idlFactory } from './key_value_store.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.KEY_VALUE_STORE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./key_value_store.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
...
/**
 * A ready-to-use agent for the key_value_store canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./key_value_store.did.js")._SERVICE>}
 */
// export const key_value_store = createActor(canisterId);
