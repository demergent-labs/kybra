...
import { idlFactory } from "./simple_erc20.did.js";
export { idlFactory } from "./simple_erc20.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SIMPLE_ERC20_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./simple_erc20.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
...
/**
 * A ready-to-use agent for the simple_erc20 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./simple_erc20.did.js")._SERVICE>}
*/
// export const simple_erc20 = createActor(canisterId);
