...
import { idlFactory } from "./principal.did.js";
export { idlFactory } from "./principal.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PRINCIPAL_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./principal.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
...
/**
 * A ready-to-use agent for the principal canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./principal.did.js")._SERVICE>}
*/
// export const principal = createActor(canisterId);
