export const idlFactory = ({ IDL }) => {
  return IDL.Service({
    'get_bool' : IDL.Func([], [IDL.Bool], ['query']),
    ...
    'get_str' : IDL.Func([], [IDL.Text], ['query']),
    'get_text' : IDL.Func([], [IDL.Text], ['query']),
    'print_bool' : IDL.Func([IDL.Bool], [IDL.Bool], ['query']),
    ...
    'print_str' : IDL.Func([IDL.Text], [IDL.Text], ['query']),
    'print_text' : IDL.Func([IDL.Text], [IDL.Text], ['query']),
  });
};
