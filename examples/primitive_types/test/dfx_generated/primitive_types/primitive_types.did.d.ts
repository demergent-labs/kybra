...
export interface _SERVICE {
  ...
  'get_str' : ActorMethod<[], string>,
  'get_text' : ActorMethod<[], string>,
  'print_bool' : ActorMethod<[boolean], boolean>,
  ...
  'print_str' : ActorMethod<[string], string>,
  'print_text' : ActorMethod<[string], string>,
}
