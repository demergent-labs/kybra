...
import { idlFactory } from './func_types.did.js';
export { idlFactory } from './func_types.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FUNC_TYPES_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./func_types.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
...
/**
 * A ready-to-use agent for the func_types canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./func_types.did.js")._SERVICE>}
 */
// export const func_types = createActor(canisterId);
