...
import { idlFactory } from "./null_example.did.js";
export { idlFactory } from "./null_example.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.NULL_EXAMPLE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./null_example.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
...
/**
 * A ready-to-use agent for the null_example canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./null_example.did.js")._SERVICE>}
*/
// export const null_example = createActor(canisterId);
