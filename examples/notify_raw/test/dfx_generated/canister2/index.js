...
import { idlFactory } from "./canister2.did.js";
export { idlFactory } from "./canister2.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER2_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./canister2.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
...
/**
 * A ready-to-use agent for the canister2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./canister2.did.js")._SERVICE>}
*/
// export const canister2 = createActor(canisterId);
