...
import { idlFactory } from "./canister1.did.js";
export { idlFactory } from "./canister1.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER1_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./canister1.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
...
/**
 * A ready-to-use agent for the canister1 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./canister1.did.js")._SERVICE>}
*/
// export const canister1 = createActor(canisterId);
