...
import { idlFactory } from "./candid_encoding.did.js";
export { idlFactory } from "./candid_encoding.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANDID_ENCODING_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./candid_encoding.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
...
/**
 * A ready-to-use agent for the candid_encoding canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./candid_encoding.did.js")._SERVICE>}
*/
// export const candid_encoding = createActor(canisterId);
