...
import { idlFactory } from './tuple_types.did.js';
export { idlFactory } from './tuple_types.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TUPLE_TYPES_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tuple_types.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
...
/**
 * A ready-to-use agent for the tuple_types canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tuple_types.did.js")._SERVICE>}
 */
// export const tuple_types = createActor(canisterId);
