...
import { idlFactory } from './heartbeat.did.js';
export { idlFactory } from './heartbeat.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.HEARTBEAT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./heartbeat.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
