...
import { idlFactory } from "./query.did.js";
export { idlFactory } from "./query.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.QUERY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./query.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
...
/**
 * A ready-to-use agent for the query canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./query.did.js")._SERVICE>}
*/
// export const query = createActor(canisterId);
