...
import { idlFactory } from "./optional_types.did.js";
export { idlFactory } from "./optional_types.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.OPTIONAL_TYPES_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./optional_types.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
...
/**
 * A ready-to-use agent for the optional_types canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./optional_types.did.js")._SERVICE>}
*/
// export const optional_types = createActor(canisterId);
