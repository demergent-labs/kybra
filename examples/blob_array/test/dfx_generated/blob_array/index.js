...
import { idlFactory } from "./blob_array.did.js";
export { idlFactory } from "./blob_array.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.BLOB_ARRAY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./blob_array.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
...
/**
 * A ready-to-use agent for the blob_array canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./blob_array.did.js")._SERVICE>}
*/
// export const blob_array = createActor(canisterId);
