...
import { idlFactory } from "./bytes.did.js";
export { idlFactory } from "./bytes.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.BYTES_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./bytes.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
...
/**
 * A ready-to-use agent for the bytes canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./bytes.did.js")._SERVICE>}
*/
// export const bytes = createActor(canisterId);
